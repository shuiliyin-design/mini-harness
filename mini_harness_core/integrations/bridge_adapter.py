...
from ..bridge.attempt_fence import (
    ATTEMPT_FENCE_LOCKED, acquire_bridge_attempt_fence,
    harness_terminal_marker_path,
)
from ..bridge.inspector import (
    CLAIMED_BY_SELF_UNKNOWN,
    COMPLETED,
    INVALID_HISTORY,
    inspect_bridge_task,
)
from ..bridge.paths import BridgePathReader, valid_task_id
from ..bridge.publisher import _json_bytes, _publish_file, _screen_payload
...
from .mobile import (
    MOBILE_WORKFLOW_EXTENSION, MobileWorkflowOutputStore, WORKFLOW_KIND,
    create_mobile_workflow_plan, validate_mobile_workflow_output,
)
...
def _start_bound_harness_run(
    ...
    terminal = harness_runner(
        ...
        mobile_workflow_extension=(
            MOBILE_WORKFLOW_EXTENSION if mobile_workflow is not None else None
        ),
